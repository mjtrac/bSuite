...
public class ViewerController {
    ...
    public String view(
        ...
        log.info("Viewer view() page request arrived: id={} path={}", id, path);
    ...
    public ResponseEntity<byte[]> image(@RequestParam Long id) throws Exception {
        ...
        log.info("Viewer image request arrived: id={}", id);
        ...
        log.info("Viewer image request done: id={} bytes={} tookMs={}", id, bytes.length, System.currentTimeMillis() - t0);
