 ...
 *
 * <p>bSuite's default implementation ({@link CornerDetectionService}) finds
...
public interface BallotCornerDetectorService {
     ...
     *                       foreign ballots without a bSuite layout file
    ...
    // Implementations and callers: import gov.election.counter.service.CornerDetectionService.Point2D
}
