...
class BarcodeReaderServiceTest {
    ...
    @Test
    @DisplayName("parseBarcodeData returns map with expected keys for bSuite format")
    ...
    @Test
    @DisplayName("parsePageNumber returns correct page from bSuite barcode")
    void testParsePageNumber() {
        // bSuite format: jurisdictionId|regionId|partyId|ballotTypeId|electionId|page
